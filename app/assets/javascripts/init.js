...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			'narrow': { range: '-1280', href: 'assets/style-narrow.css', containers: 960 },
			'narrower': { range: '-1000', href: 'assets/style-narrower.css', containers: '95%' },
			'mobile': { range: '-736', href: 'assets/style-mobile.css', grid: { gutters: 20 } },
